...
/**
 * @module pokemon-expectation-vs-reality/server
 */
...
const URL_ROOT = "/pokemon-expectation-vs-reality/"
 ...
 * @name get/get
 * @function
 * @memberof module:pokemon-expectation-vs-reality/server~serverRoutes
 * @inner
 * @param {string} path The route URL.
 * @param {callback} middleware The Express callback function to trigger.
 */
...
/**
 * Queries the database for the total number of matches each Pokemon has participated in and returns the results to the client.
 * @name get/matches
 * @function
 * @memberof module:pokemon-expectation-vs-reality/server~serverRoutes
 * @inner
